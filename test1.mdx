---
description: |-
  The user guide explains how to use the Medusa Admin for non technical users.
  Learn through easy steps how to use the Medusa admin to perform different
  operations and ecommerce tasks.
slug: test1-mdx
title: test1.mdx
sidebar_position: 2
---
...
At the top right you’ll find a icon. Clicking this icon opens a side window to view any notifications you might have. You can use this to view notifications such as completed product exports.
