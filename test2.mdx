---
description: >-
  Medusa is an open source composable commerce platform. Learn about its
  ...
  items={[
    {
      ...
      customProps: {
        icon: ["tag-solid"],
        description:
          "Check out the Medusa UI package, a React implementation of the Medusa design system."
      }
    },
    {
      type: "link",
      ...
      customProps: {
        ...
        badge: { variant: "orange", children: "Beta" }
      }
    },
    {
      type: "link",
